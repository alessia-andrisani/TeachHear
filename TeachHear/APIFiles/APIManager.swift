...
public class APIManager: ObservableObject {
    ...
    public func fetchData (userInput: String) async {
        ...
        let firstDataURL = "https://api.musixmatch.com/ws/1.1/track.search?q=\(userInput)&apikey=0d79498daea98df76c2aa81a7f3b127b"

  
        
        if firstDataURL == "https://api.musixmatch.com/ws/1.1/track.search?q=xoloitzcuintle&apikey=0d79498daea98df76c2aa81a7f3b127b"  || firstDataURL == "https://api.musixmatch.com/ws/1.1/track.search?q= xoloitzcuintle&apikey=0d79498daea98df76c2aa81a7f3b127b"  {
