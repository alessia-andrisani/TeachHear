...
public class IDTrackManager: ObservableObject {
    ...
    func fetchData (inputTittlesList: ArraySlice<Track>?, listOfTrackedSongs: ArraySlice<Track>?, listAppearance: Bool) async {
        ...
        for i in 0...counter {
            ...
            listOfSongURLs![i] = "https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=\(listOfTrackedIDs![i])&apikey=0d79498daea98df76c2aa81a7f3b127b"
            ...
            if listOfSongURLs == nil  {
                ...
                //URL
                if let url = URL(string: listOfSongURLs?[i] ?? "https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=0&apikey=0d79498daea98df76c2aa81a7f3b127b")
                    
                {
                    //With the if statement below we check that we have a valir URL
                    if listOfSongURLs?[i] == "https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=0&apikey=0d79498daea98df76c2aa81a7f3b127b"  {
